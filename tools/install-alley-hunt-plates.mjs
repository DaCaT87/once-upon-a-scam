...
const CARDS = [
  ['thousand-maws', `${ASSETS}/c__Users_copan_AppData_Roaming_Cursor_User_workspaceStorage_39f0117879db467f92618b6dc4c58c15_images_Thousand_Maws-b30552a3-6ed3-4e2c-941b-5b4fd27a8285.jpg`],
  ['mad-woodsman', `${ASSETS}/c__Users_copan_AppData_Roaming_Cursor_User_workspaceStorage_39f0117879db467f92618b6dc4c58c15_images_Mad_Woodsman-30632fc4-a0b6-4749-b86b-27eff36fb813.jpg`],
  ['sewer-lord', `${ASSETS}/c__Users_copan_AppData_Roaming_Cursor_User_workspaceStorage_39f0117879db467f92618b6dc4c58c15_images_Sewer_Lord-af900df9-d104-4965-9820-ae95b31f90cb.jpg`],
  ['purple-widows', `${ASSETS}/c__Users_copan_AppData_Roaming_Cursor_User_workspaceStorage_39f0117879db467f92618b6dc4c58c15_images_Purple_Widow-d07dc44e-a494-4f66-b7c9-49f8b9ee1f21.jpg`],
  ['greed-fang', `${ASSETS}/c__Users_copan_AppData_Roaming_Cursor_User_workspaceStorage_39f0117879db467f92618b6dc4c58c15_images_Avarice_Wyrm-db2ec800-c870-4d04-8622-f6c9399352b1.jpg`],
];
...
function fitInner(cropped, inner, tw, th) {
  ...
  const scaled = scaleTo(cropped, dw, dh);
  const box = {
...
const prepared = CARDS.map(([id, srcPath]) => {
  const framed = decodeImage(readFileSync(srcPath));
  ...
  return {
    ...
    padL: fitted.box.l,
    padT: fitted.box.t,
    padR: fitted.img.width - 1 - fitted.box.r,
    padB: fitted.img.height - 1 - fitted.box.b,
  };
});
...
for (const item of prepared) {
  const plate = centerOnCanvas(item.fitted, canvasW, canvasH);
  const dest = `${UI}/plate-hunt-${item.id}.png`;
  writePng(plate, dest);
  console.log(item.id, `pads ${item.padL},${item.padT},${item.padR},${item.padB}`, `out ${plate.width}x${plate.height}`);
}
