...
const KEY = [0, 254, 102];
const SRC =
  'C:/Users/copan/.cursor/projects/c-Users-copan-Desktop-Once-Upon-a-Scam/assets/c__Users_copan_AppData_Roaming_Cursor_User_workspaceStorage_39f0117879db467f92618b6dc4c58c15_images_Sticker-ea9a616e-b11a-4f40-8449-574c4c3ee3ff.jpg';
const DEST = 'C:/Users/copan/Desktop/Once Upon a Scam/public/art/ui/plate-sticker.png';
...
writePng(plate, DEST);
console.log('sticker', `${framed.width}x${framed.height}`, '->', `${plate.width}x${plate.height}`);
