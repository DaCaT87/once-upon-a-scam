...
const KEY = [0, 254, 102];
const SRC =
  'C:/Users/copan/.cursor/projects/c-Users-copan-Desktop-Once-Upon-a-Scam/assets/plate-witch-oven-house.png';
...
writePng(plate, DEST);
console.log('oven', `${framed.width}x${framed.height}`, '->', `${plate.width}x${plate.height}`);
