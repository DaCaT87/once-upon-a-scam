...
const KEY = [0, 254, 102];
const SRC =
  'C:/Users/copan/.cursor/projects/c-Users-copan-Desktop-Once-Upon-a-Scam/assets/c__Users_copan_AppData_Roaming_Cursor_User_workspaceStorage_39f0117879db467f92618b6dc4c58c15_images_Purple_Widow-d4d15edc-11bb-4853-b655-39453be58eb5.jpg';
const DEST = 'C:/Users/copan/Desktop/Once Upon a Scam/public/art/ui/plate-hunt-purple-widows.png';
...
const plate = blank(CANVAS_W, CANVAS_H);
blit(plate, fitted.img, Math.round((CANVAS_W - CARD_W) / 2 - fitted.box.l), Math.round((CANVAS_H - CARD_H) / 2 - fitted.box.t));
writePng(plate, DEST);
console.log(
  'purple-widows',
  `${framed.width}x${framed.height}`,
  `inner ${inner.r - inner.l + 1}x${inner.b - inner.t + 1}`,
  `out ${plate.width}x${plate.height}`,
);
